...
import static com.example.qr_readerexample.R.id.chart;
import static com.example.qr_readerexample.activity.MainActivity.myDb;

public class DataTrendActivity extends BaseActivity {

    private static final String TAG = "DataTrendActivity";
    @BindView(R.id.title)
    TextView title;
